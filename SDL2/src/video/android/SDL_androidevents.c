...
Android_PumpEvents(_THIS)
{
    ...
    /*
     * Android_ResumeSem and Android_PauseSem are signaled from Java_org_milkytracker_sdl_SDLActivity_nativePause and Java_org_milkytracker_sdl_SDLActivity_nativeResume
